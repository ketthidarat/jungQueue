# Generated by Django 2.2.7 on 2021-02-18 06:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('money_status', models.ForeignKey(default=' ', on_delete=django.db.models.deletion.CASCADE, to='api.Money_status', verbose_name='สถานะการชำระเงิน')),
                ...
                ('work_status', models.ForeignKey(default=' ', on_delete=django.db.models.deletion.CASCADE, to='api.Work_status', verbose_name='สถานะงาน')),
            ],
            options={
