            ...
            child: Card(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text("${work.lat}"),
                  Text("ราคา: ${work.lng}"),
                  Text("ขนาดสินค้า : ${work.dateStart}"),
                  Text("สีสินค้า : ${work.dateEnd}"),
                  Text("${work.area}"),
                  Text("${work.riceType}"),
                  Text("ราคา: ${work.repairTime}"),
                  Text("ขนาดสินค้า : ${work.harverstime}"),
                  Text("สีสินค้า : ${work.money}"),
                  Text("${work.moneyStatus}"),
                  Text("${work.workStatus}"),
                  Text("ราคา: ${work.tractor}"),
                  Text("ขนาดสินค้า : ${work.tractorStatus}"),
                  // Text("สีสินค้า : ${work.money}"),
